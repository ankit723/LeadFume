...
export default function PoliciesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 hover">
        <Link 
          href="/policies/terms-of-service"
          className="p-6 border rounded-lg  transition-all hover:bg-gray-50 hover:shadow-md hover:scale-105"
        >
